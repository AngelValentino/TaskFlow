  ...
  static getHtml(
    ...
    const getReturnHomeBtn = () => {
      return returnBackHome
        ? ` <div class="header-return-home-link-container">
              <a title="Return home" class="header-return-home-link" href="/" data-link>
                <svg aria-hidden="true" focusable="false" class="header-return-home-svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
