export default class EnhancedTaskManagerTabs {
  static getHtml() {
    return `
      <ul class="enhanced-task-manager__nav-list" id="task-manager__tab-list" aria-label="Tasks manager tab sections list.">
        <li>
          <ul class="enhanced-task-manager__tab-list" role="tablist">
        ...
        <li>
          <button title="Search task" class="enhanced-task-manager__search-btn enhanced-task-manager__tab-btn" id="task-manager__dashboard-search-btn" aria-label="Search task." type="button" aria-controls="task-manager__search-prompt" aria-expanded="false">
        ...
        <li>
          <button aria-haspopup="dialog" title="Clear all tasks" class="enhanced-task-manager__tab-btn" id="task-manager__dashboard-clear-btn" aria-label="Clear all tasks." type="button">
        ...
        <li>
          <button title="Scroll to top of list" id="task-manger__scroll-to-top-btn" class="enhanced-task-manager-to-top-btn enhanced-task-manager__tab-btn">
            <svg aria-hidden="true" focusable="false" role="presentation" class="enhanced-task-manager__tab-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
