    ...
    return `
      <ul id="task-manager__tab-list" class="enhanced-task-manager__tab-list" role="tablist">
        <li role="presentation">
          <button title="Show all tasks" aria-selected="true" aria-expanded="true" role="tab" class="enhanced-task-manager__tab-btn" id="task-manger__all-tasks-tab-btn" aria-label="Ahow all tasks." aria-controls="task-manager__task-list-container">
        ...
        <li role="presentation">
          <button title="Show active tasks" aria-selected="false" aria-expanded="false" role="tab" class="enhanced-task-manager__tab-btn" id="task-manager__active-tasks-tab-btn" aria-label="Show active tasks." aria-controls="task-manager__task-list-container">
            <svg aria-hidden="true" focusable="false" role="presentation" class="enhanced-task-manager__tab-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li role="presentation">
          <button title="Show completed tasks" aria-selected="false" aria-expanded="false" role="tab" class="enhanced-task-manager__tab-btn" id="task-manger__completed-tasks-tab-btn" aria-label="Show completed tasks." aria-controls="task-manager__task-list-container">
            <svg aria-hidden="true" focusable="false" role="presentation" class="enhanced-task-manager__tab-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <g fill="none" fill-rule="evenodd">
                <path d="m12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.036q-.016-.004-.024.006l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.014.002l-.184.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.003-.011l.018-.43l-.003-.012l-.01-.01z"></path>
