    ...
    return `
      <article aria-label="Pomodoro timer widget." id="pomodoro-timer" role="region" class="pomodoro-timer">
        ...
        <div id="pomodoro-timer__options" class="pomodoro-timer__options">
          <button aria-controls="pomodoro-timer__clock" aria-label="Set long session for pomodoro timer. 45 minutes work, and 10 minutes rest." title="Set long session" aria-pressed="false" id="pomodoro-timer__long-session-btn" class="pomodoro-timer__long-session-btn"></button>
