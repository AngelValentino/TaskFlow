    ...
    return `
      <div class="task-manager__dashboard">
        ...
        <ul aria-label="Task manager control buttons." class="task-manager__dashboard-btns-list">
          ...
          <li>
            <button aria-expanded="false" title="Clear all tasks" class="task-manager__dashboard-btn" id="task-manager__dashboard-clear-btn" aria-label="Clear all tasks." type="button">
