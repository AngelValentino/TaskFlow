      ...
      <div class="task-manager__dashboard">
        ...
        <ul aria-label="Task manager control buttons." class="task-manager__dashboard-btns-list">
          <li class="task-manager__dashboard-add-btn-container">
            <button title="Add task" class="task-manager__dashboard-btn" id="task-manager__dashboard-add-btn" type="button" aria-label="Add new todo." aria-controls="add-todo-prompt" aria-expanded="false">
          ...
          <li>
            <button title="Search task" class="task-manager__dashboard-btn" id="task-manager__dashboard-search-btn" aria-label="Search todo." type="button" aria-controls="search-todo-prompt" aria-expanded="false">
          ...
          <li>
            <button aria-expanded="false" title="Clear all todos" class="task-manager__dashboard-btn" id="task-manager__dashboard-clear-btn" aria-label="Clear all todos." type="button">
