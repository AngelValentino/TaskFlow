...
export default class Task {
  ...
  static getHtml(task, searchValue) {
    return `
      <li id="task-manager__task-${task.id}" aria-label="Active task." class="task-manager__task">
        <h4 class="task-manager__task-title">${searchValue ? this.utils.highlighter(task.title, searchValue) : task.title}</h4>
        <time class="task-manger__task-due-date" datetime="${task.due_date}">Due to ${this.utils.formatDate(task.due_date).longFormat}</time>
        ...
        <ul aria-label="Task controls." class="task-manager__control-btns-list">
          <li>
            <button aria-haspopup="dialog" title="Complete task" class="task-manager__complete-task-btn appear-bg-from-center rounded" aria-label="Complete task." type="button">
          ...
          <li>
            <ul class="task-manager__control-btns-list-inner">
              <li>
                <button aria-haspopup="dialog" title="Edit task" id="task-manager__edit-task-btn-${task.id}" class="task-manager__edit-task-btn appear-bg-from-center rounded" aria-label="Edit task." type="button">
              ...
              <li>
                <button aria-haspopup="dialog" title="Delete task" class="task-manager__delete-task-btn appear-bg-from-center rounded" aria-label="Delete task." type="button">
