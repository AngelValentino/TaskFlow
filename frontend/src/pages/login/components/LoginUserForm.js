      ...
      <div class="login-view-container">
        ...
        <form id="login-form" class="login-form">
          <div class="login-form__inputs-container">
            ...
            <input required placeholder="Email address" autocomplete="email" class="login-form__email-input" id="login-form__email-input" type="email" name="email">
            <label class="login-form__password-label" for="login-form__password-input">Password</label>
            <input required placeholder="Password" class="login-form__password-input" id="login-form__password-input" type="password" name="password" autocomplete="current-password">
          </div>
