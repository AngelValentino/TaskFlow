    ...
    return `
      <form id="login-form" class="auth-form">
        <div class="auth-form__inputs-container">
          ...
          <input required placeholder="Email address" autocomplete="email" class="auth-form__email-input" id="login-form__email-input" type="email" name="email">
          <label class="auth-form__password-label" for="login-form__password-input">Password</label>
          <input required placeholder="Password" class="auth-form__password-input" id="login-form__password-input" type="password" name="password" autocomplete="current-password">
        </div>
