    ...
    return `
      <div id="info-modal-container" class="info-modal-container">
        <div class="info-modal" id="info-modal" role="dialog" aria-describedby="dialog__desc">
          <img class="dialog__capybara-placeholder-img" src="public/assets/images/drawings/chilling-capybara.jpg" alt="A drawing of capybara having a bath in a hot tub with a rubber duck on its head."/>
